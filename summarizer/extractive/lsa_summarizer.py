# summarizer/extractive/lsa_summarizer.py
...
class LSASummarizer(BaseExtractiveSummarizer):
    """
    Latent Semantic Analysis (LSA) algorithm implementation for extractive summarization.
    ...
    def __init__(self, language: str = "english"):
        ...
        self.summarizer = SumyLsaSummarizer()

    def get_metadata(self) -> Dict[str, Any]:
        """Override metadata with LSA specific information"""
        metadata = super().get_metadata()
        metadata.update({
            "name": "LSA",
            "description": "Latent Semantic Analysis based extractive summarization",
    ...
    def summarize(self, text: str, sentences_count: int = 3, **kwargs) -> str:
        ...
        try:
            ...
            print(f"Error in LSA summarization: {e}")
    ...
    def get_ranked_sentences(self, text: str, **kwargs) -> List[Dict[str, Any]]:
        """
        Get sentences ranked by LSA importance score
        ...
        try:
            ...
            print(f"Error in LSA sentence ranking: {e}")
            return []
