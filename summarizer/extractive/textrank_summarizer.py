# summarizer/extractive/textrank_summarizer.py
...
class TextRankSummarizer(BaseExtractiveSummarizer):
    ...
    def __init__(self, language: str = "english"):
        ...
        self.summarizer = SumyTextRankSummarizer()

    def get_metadata(self) -> Dict[str, Any]:
        """Override metadata with TextRank specific information"""
        metadata = super().get_metadata()
        metadata.update({
            "name": "TextRank",
            "description": "Graph-based extractive summarization using TextRank algorithm",
    ...
    def get_ranked_sentences(self, text: str, **kwargs) -> List[Dict[str, Any]]:
        """
        Get sentences ranked by TextRank importance score
        ...
        try:
            ...
            print(f"Error in TextRank sentence ranking: {e}")
            return []
