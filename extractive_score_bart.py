...
class RSSFeedSummarizer:
    ...
    def _visualize_results(self, results):
        ...
        plt.figure(2)
        plt.savefig('best_extractive_method_distribution.png',
                    dpi=300, bbox_inches='tight')
        plt.close('all')

        print("\nVisualization saved as 'multi_extractive_bart_hybrid_results.png' and 'best_extractive_method_distribution.png'.")
